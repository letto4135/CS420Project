#pragma checksum "/Users/alife/Other/CS420Project/RestaurantFrontEnd/Pages/Kitchen/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7c39adeaa71c5bcd8787633777dd927f64d3d275"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7c39adeaa71c5bcd8787633777dd927f64d3d275", @"/Pages/Kitchen/Index.cshtml")]
...
<script>
    async function getAvailableFoodOrders() {
        ...
        while (true) {
          ...
          ");
            WriteLiteral(@"                      foodName = food[i][0];
                                foodPrice = food[i][1];
                                newRowText +=`
                                                    <div>
                                                        <p>${foodName}</p>
    ...
    function deleteTableRow(x) {
        var list = document.getElementById(""avai");
            WriteLiteral(@"lableFoodOrders"");
